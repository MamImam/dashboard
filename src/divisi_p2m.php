  ...
  <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
    <header class="app-header navbar">
      ...
      <ul class="nav navbar-nav d-md-down-none">
        ...
        <li class="nav-item px-3">
          <a class="nav-link" href="divisi_p2m.php">Divisi P2M</a>
        </li>
        <li class="nav-item px-3">
    ...
    <div class="app-body">
          ...
          <ul class="nav">
            ...
            <li class="nav-item nav-dropdown">
              <a class="nav-link nav-dropdown-toggle" href="#">
                <i class="nav-icon icon-puzzle"></i>Aktivitas Advokasi</a>
            ...
            <li class="nav-item nav-dropdown">
              <a class="nav-link nav-dropdown-toggle" href="#">
                <i class="nav-icon icon-cursor"></i>Aktivitas PIE P4GN</a>
              <ul class="nav-dropdown-items">
                <li class="nav-item">
            ...
            <li class="nav-item nav-dropdown">
              <a class="nav-link nav-dropdown-toggle" href="#">
                <i class="nav-icon icon-star"></i><center>Aktivitas Pemberdayaan Masyarakat</center></a>
              <ul class="nav-dropdown-items">
                <li class="nav-item">
            ...
            <li class="nav-item nav-dropdown">
              <a class="nav-link nav-dropdown-toggle" href="#">
                <i class="nav-icon icon-bell"></i>Agenda Kegiatan</a>
              <ul class="nav-dropdown-items">
                <li class="nav-item">
      ...
      <main class="main">
        <!-- Breadcrumb-->
        <ol class="breadcrumb">
          <li class="breadcrumb-item active">DIVISI PENCEGAHAN DAN PEMBERDAYAAN MASYARAKAT</li>
          <!-- Breadcrumb Menu-->
