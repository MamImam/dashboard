            ...
            <div class="card card-chart">
              <div class="card-header ">
                ...
                <?php
                  ...
                  $con=mysqli_query($koneksi, "SELECT*FROM tb_bb");
                  while ($data =mysqli_fetch_array($con)) {
                  ?>
                  <tr>
                    <td><?php echo $data['id_bb']?></td>
                    <td><?php echo $data['nama_bb']?></td>
                    <td><?php echo $data['jenis_bb']?></td>
                    <td><a href="hapus_bb.php?d=<?= $data['id_bb'] ?>">Hapus</a> || <a href="edit_bb.php?d=<?= $data['id_bb'] ?>">Edit</a></td>
                  </tr>
                <?php } ?>
                </div>
              </table>
