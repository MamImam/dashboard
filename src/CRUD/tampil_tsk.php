  ...
  <div class="wrapper">
    ...
    -->
      <div class="sidebar-wrapper">
        ...
        <ul class="nav">
          <li class="active ">
            <a href="insert_tsk.php">
              <i class="tim-icons icon-chart-pie-36"></i>
              <p><h4>Tersangka</h4></p>
            </a>
          </li>
          <li>
            <a href="insertb_bb.php">
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        ...
        <li class="nav-item px-3">
          <a class="nav-link" href="tampil_tsk.php">Laporan Tersangka</a>
        </li>
        <li class="nav-item px-3">
          <a class="nav-link" href="tampil_bb.php">Laporan Barang Bukti</a>
        </li>
        <li class="nav-item px-5">
            ...
            <div class="card card-chart">
              <div class="card-header ">
                <div class="row">
                  ...
                  <td>Kelurahan tersangka</td>
                  <td>Kecamatan tersangka</td>
                  <td>Tempat tanggal lahir tersangka</td>
                  <td>Jenis kelamin tersangka</td>
                  <td>Usia tersangka</td>
                  <td>pekerjaan tersangka</td>
                  <td>pendidikan tersangka</td>
                  <td colspan="2">Aksi</td>
                </tr>
                <?php
                  require_once 'koneksi.php';
                  $con=mysqli_query($koneksi, "SELECT*FROM tb_tsk");
                  while ($data =mysqli_fetch_array($con)) {
                  ?>
                  <tr>
                    <td><?php echo $data['id_tsk']?></td>
                    <td><?php echo $data['nama_tsk']?></td>
                    <td><?php echo $data['alamat_tsk']?></td>
                    <td><?php echo $data['kelurahan_tsk']?></td>
                    <td><?php echo $data['kecamatan_tsk']?></td>
                    <td><?php echo $data['ttl_tsk']?></td>
                    <td><?php echo $data['jk_tsk']?></td>
                    <td><?php echo $data['usia_tsk']?></td>
                    <td><?php echo $data['pekerjaan_tsk']?></td>
                    <td><?php echo $data['pendidikan_tsk']?></td>
                    <td><a href="hapus_tsk.php?d=<?= $data['id_tsk'] ?>">Hapus</a>
                      || <a href="edit_tsk.php?d=<?= $data['id_tsk'] ?>">Edit</a></td> 
                  </tr>
                <?php } ?>
                </div>
              </table>
