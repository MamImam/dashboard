...
$asal_barang_lkn = $_POST['asal_barang_lkn'];
 ...
 if ($u) {
   echo "<script>alert('terima kasih, data berhasil di edit');window.location='../divisi_pemberantasan.php'</script>";
 }else {
   echo "<script>alert('maaf, data gagal diedit');window.location='../divisi_pemberantasan.php'</script>";
 }
?>
