  ...
  <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
    <header class="app-header navbar">
      ...
      <ul class="nav navbar-nav d-md-down-none">
        <li class="nav-item px-3">
          <a class="nav-link" href="divisi_umum.php">Divisi Umum</a>
        </li>
        <li class="nav-item px-3">
    ...
    <div class="app-body">
        ...
        <nav class="sidebar-nav">
          <ul class="nav">
            ...
            <li class="nav-item nav-dropdown">
              <a class="nav-link nav-dropdown-toggle" href="./CRUD/insert_datapegawai.php">
                <i class="nav-icon icon-puzzle"></i>Data Pegawai</a>
            ...
            <li class="nav-item nav-dropdown">
              <a class="nav-link nav-dropdown-toggle" href="./CRUD/insert_skkp.php">
                <i class="nav-icon icon-cursor"></i>SKKP</a>
              <ul class="nav-dropdown-items">
                <li class="nav-item">
            ...
            <li class="nav-item nav-dropdown">
              <a class="nav-link nav-dropdown-toggle" href="./CRUD/insert_skkgb.php">
                <i class="nav-icon icon-star"></i>SKKGB</a>
              <ul class="nav-dropdown-items">
                <li class="nav-item">
      ...
      <main class="main">
        <!-- Breadcrumb-->
        <ol class="breadcrumb">
          <li class="breadcrumb-item active">DIVISI UMUM</li>
          <!-- Breadcrumb Menu-->
                    ...
                    <table class="table table-responsive-sm table-hover table-outline mb-0">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar">
                              <img class="img-avatar" src="img/avatars/Logo_BNN.png" alt="admin@bootstrapmaster.com">
                              <span class="avatar-status badge-danger"></span>
                            </div>
                          </td>
                          <td>
