  ...
  <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
    <header class="app-header navbar">
      ...
      <a class="navbar-brand" href="index.html">
        <img class="navbar-brand-full" src="img/brand/BNN.png" width="89" height="40">
      ...
      <ul class="nav navbar-nav d-md-down-none">
        <li class="nav-item px-3">
          <a class="nav-link" href="login.html">Divisi Umum</a>
        </li>
        <li class="nav-item px-3">
          <a class="nav-link" href="login.html">Divisi P2M</a>
        </li>
        <li class="nav-item px-3">
          <a class="nav-link" href="login.html">Divisi Rehabilitasi</a>
        </li>
        <li class="nav-item px-3">
          <a class="nav-link" href="login.html">Divisi Pemberantasan</a>
        </li>
      </ul>
      <ul class="nav navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
            <img class="img-avatar" src="img/avatars/Logo_BNN.png">
          </a>
