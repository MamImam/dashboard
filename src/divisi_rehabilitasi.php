  ...
  <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
    <header class="app-header navbar">
      ...
      <ul class="nav navbar-nav d-md-down-none">
        ...
        <li class="nav-item px-3">
          <a class="nav-link" href="divisi_rehabilitasi.php">Divisi Rehabilitasi</a>
        </li>
        <li class="nav-item px-3">
    ...
    <div class="app-body">
        ...
        <nav class="sidebar-nav">
          <ul class="nav">
            ...
            <li class="nav-item nav-dropdown">
              <a class="nav-link nav-dropdown-toggle" href="CRUD/insert_rehab.php">
                <i class="nav-icon icon-puzzle"></i>Data Rehab</a>
      ...
      <main class="main">
        <!-- Breadcrumb-->
        <ol class="breadcrumb">
          <li class="breadcrumb-item active">DIVISI REHABILITASI</li>
          <!-- Breadcrumb Menu-->
