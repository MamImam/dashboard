...
<head>
  ...
  <link rel="icon" type="image/png" href="../src/img/Logo_BNN.png">
  <title>
  ...
  <div class="wrapper">
    ...
    -->
      <div class="sidebar-wrapper">
        ...
        <ul class="nav">
          <li class="active ">
            <a href="./CRUD/insert_rehab.php">
              <i class="tim-icons icon-chart-pie-36"></i>
              <p><h5>Data Rehab</h5></p>
            </a>
          </li>
        </ul>
      </div>
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="divisi_rehabilitasi.php">BNNK SURABAYA</a>
          </div>
